						 ...
						 const Standard_Real tolerance) 
{
  ...
  Standard_Boolean wasSP = BRep_Tool::SameParameter ( edge ), SP = Standard_False;
  {
	...
	B.SameParameter ( copyedge, Standard_False );
        //Roman Lygin Jun 18, 2009
        //ShapeBuild_Edge::Copy() may change 3D curve range (if it's outside of
        //its period). In this case pcurves in BRepLib::SameParameter() will be
        //changed as well and later ShapeBuild_Edge::CopyPCurves() will copy
        //pcurves keeping original range. To prevent this discrepancy we enforce
        //original 3D range.
        Standard_Real aF, aL;
