...
//purpose  : Iterates over all (sub-)shapes in the XDE document (not only
//           children of labels). However, given that there will be no
//           resulting entities for shapes other than referred to by labels
//           (including sub-shapes, located instances, etc) orphan layers will
//           be ignored. See also WriteNames().
//=======================================================================
...
//           resulting entities for shapes other than referred to by labels
//           (including sub-shapes, located instances, etc) orphan layers will
//           be ignored. See also WriteLayers().
//=======================================================================
